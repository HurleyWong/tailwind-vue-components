<template>
  <div
    class="min-w-screen min-h-screen bg-gray-150 flex items-center justify-center px-5 py-5"
  >
    <div
...
export default {
  ...
  mounted() {
    ...
    s2.src = "https://cdnjs.cloudflare.com/ajax/libs/zxcvbn/4.4.2/zxcvbn.js";
